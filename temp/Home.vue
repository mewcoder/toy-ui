...
import ZRate from "../components/rate/rate.vue";
// import ZMessage from "../components/message/message.vue";
export default {
  components: { ZDialog, ZButton, ZRate },
  name: "Home",
  data() {
    return {
      dialogVisible: false,
